...
A uma nação forte, conquistadora,^&#42;2^
...
^<<v23-18-3,3>>^ Todos vocês, habitantes da terra, os que nela residem,
O que verão será como um sinal^&#42;1^ erguido sobre as montanhas,
...
^<<v23-18-7,7>>^ Nesse tempo uma nação de estatura elevada e de pele lisa,^&#42;1^
